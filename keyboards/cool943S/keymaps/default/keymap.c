...
*/  
  [_LOWER] = LAYOUT(
    ...
    KC_LSFT, KC_PPLS,    KC_PMNS,    KC_PAST,    KC_PSLS,    KC_PEQL,    KC_GRV,    KC_JYEN,    RSFT(KC_LBRC),   RSFT(KC_RBRC),  RSFT(KC_RO), KC_RSFT,
...
*/  
  ...
  [_RAISE] = LAYOUT(
    ...
    KC_LCTL,  KC_AT,    KC_BSLS,    KC_SCLN,    KC_QUOT,    KC_G,    KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_EQL, KC_ENT,
